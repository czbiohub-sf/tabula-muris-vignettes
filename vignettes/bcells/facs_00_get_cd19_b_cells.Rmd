...
```{r}
genes_to_check= c('Cd19', 'Ptprc', 'Cd79a')
...
```{r}
tiss_facs_cd19 = SubsetData(object = tiss_facs_immune, ident.use = c(0, 2))
...
```{r}
save(tiss_facs_cd19, file = here('vignettes', 'immune', 'facs_cd19.Robj'))
```
