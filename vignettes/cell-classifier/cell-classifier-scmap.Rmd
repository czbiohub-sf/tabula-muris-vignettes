...
We will use 250 features instead of the default 500 because we have found that selecting a smaller number of features improves the classification of FACS/smartseq data. We suggest you to fine tune this parameter when loading your own data.
...
```
<!--
heatmap.2(as.matrix(metadata(sce.tm_droplet)$scmap_cluster_index),margins=c(10,1), trace="none", scale = "row", Rowv = F,cexCol=0.75, key = FALSE, labRow = "")
```
-->
