...
2nd column: corresponding cell types as defined in the cell ontology associated with the 10x genomics (droplet) dataset
3rd:end columns: corresponding cell types as defined in the cell ontology associated with the microwell sequencing dataset
