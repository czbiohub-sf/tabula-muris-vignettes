...
```{r}
FACS_files = list.files(here("tabula-muris", "00_data_ingest","00_facs_raw_data","FACS"), full.names = TRUE)
...
```{r}
meta.data <- read.csv(here("tabula-muris", "00_data_ingest","01_droplet_raw_data", "metadata_droplet_clean.csv"))
